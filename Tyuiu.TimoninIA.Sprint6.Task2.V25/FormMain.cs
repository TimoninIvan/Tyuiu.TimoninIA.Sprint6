using Tyuiu.TimoninIA.Sprint6.Task2.V25.Lib;
namespace Tyuiu.TimoninIA.Sprint6.Task2.V25
{
    public partial class FormMain : Form
    {
        ...
        {
            MessageBox.Show("Таск 1 Выполнил студент группы ИИПБ 24-1 Тимонин Иван Александрович", "О программе", MessageBoxButtons.OK);
        }
